...
**Los mismos datos que en tu computadora**: en la computadora corre `./flecha --red` (en la app de Mac: menú *Compartir con mi iPhone o iPad* y luego *Código para el teléfono*). En el teléfono: engrane → toca tu computadora, que aparece sola si están en la misma red wifi → escribe el código de 6 dígitos. Si no aparece, el enlace con clave que imprime la terminal (o que la app de Mac copia al portapapeles) también sirve. Fuera de casa puedes seguir palomeando: los cambios se guardan en una cola y se entregan, sin pisar lo que haya cambiado la computadora, cuando vuelves a su red. La clave vive en `~/.flecha/clave`; bórrala para generar otra y desconectar a todos. Sin conectar, la app lleva sus propios datos en el teléfono.
