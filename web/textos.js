...
(function (raiz) {
  ...
  const es = {
    ...
    tuMac: 'Tu Mac',
    fondoWidget: 'Fondo del widget',
    notaFondoWidget: 'iOS no deja que un widget sea transparente. Si tu fondo de pantalla es de un solo color, elige aquí ese mismo color y el recuadro se pierde en el fondo.',
  ...
  const en = {
    ...
    tuMac: 'Your Mac',
    fondoWidget: 'Widget background',
    notaFondoWidget: 'iOS does not allow transparent widgets. If your wallpaper is a single color, pick that same color here and the box blends into it.',
